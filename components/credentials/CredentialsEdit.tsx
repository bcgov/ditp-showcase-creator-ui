  ...
  return (
    <>
      ...
      <div className="flex justify-between">
        <div>
          <p className="text-slate-100 text-sm">{t('credentials.edit_header_subtitle')}</p>
      ...
      <div className="my-6">
        <label className="text-md font-bold" htmlFor="name">
          {t('credentials.edit_credential_name_label')}
        </label>
        <input
          type="text"
          id="cred_name"
          name="cred_name"
          placeholder={t('credentials.edit_credential_name_placeholder')}
          value={
      ...
      <div className="my-6">
        <label className="text-md font-bold" htmlFor="issuer_name">
          {t('credentials.edit_issuer_name_label')}
        </label>
        <input
          type="text"
          id="issuer_name"
          name="issuer_name"
          placeholder={t('credentials.edit_issuer_name_placeholder')}
          value={
            selectedCredential !== null && tempData[selectedCredential]
      ...
      <div className="my-6">
        <label className="text-md font-bold">{t('credentials.edit_add_attributes_label')}</label>
