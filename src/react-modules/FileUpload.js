...
function FileUploadFull({text}) {
    ...
    return(
        <div class="flex p-1 items-center flex-col justify-center w-full">
            ...
            <label for="dropzone-file" class="p-3 flex flex-col items-center justify-center w-full h-48 border-2 border-zinc-300 border-dashed rounded-lg cursor-pointer dark:hover:bg-zinc-800 dark:bg-zinc-700 hover:bg-zinc-100 dark:border-zinc-600 dark:hover:border-zinc-500 dark:hover:bg-zinc-600">
                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                    ...
                    <p class="text-xs text-zinc-500 dark:text-zinc-400">(SVG, PNG, JPEG, JPG)</p>
                </div>
