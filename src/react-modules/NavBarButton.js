...
export const NavBarButton = ({ src, title, page, changePage }) => {
    return (
        

            <li className="flex flex-col  items-center justify-between p-3 rounded-b-lg bg-slate-900  hover:yellow cursor-pointer hover:text-black"style={{ width: '106px', height:'93px', padding:'13px, 0px, 13px, 0px' }}
